...
Nas próximas conversas, podemos evoluir isso em etapas:

1. gerar a estrutura real de pastas
2. definir as interfaces e entidades
3. implementar o primeiro caso de uso
4. criar o controller HTTP
5. escrever testes
6. trocar memória por banco real
7. adicionar mensageria
8. adaptar para NestJS
